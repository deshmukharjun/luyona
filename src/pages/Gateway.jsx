  ...
  return (
    <div className="h-screen w-screen flex flex-col justify-between items-center px-6 py-10 bg-white">
      ...
      <div className="flex flex-col items-center justify-center flex-1">
        <img src="/logogray.png" alt="Luyona Logo" className="h-12 mb-4" />
      ...
      <div className="w-full">
        ...
        <button className="w-full py-4 rounded-xl border border-[#222222] bg-white text-[#222222] text-sm font-medium">
          I want to login
        </button>
      </div>
    </div>
